...
with read_base():
    from .mmpretrain.mmpretrain.configs._base_.datasets.imagenet_bs64_pil_resize_autoaug import *
    from .mmpretrain.mmpretrain.configs._base_.default_runtime import *
    from .mmpretrain.mmpretrain.configs._base_.models.vit_base_p16 import *
