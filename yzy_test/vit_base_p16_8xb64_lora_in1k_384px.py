...
with read_base():
    from .mmpretrain.mmpretrain.configs._base_.datasets.imagenet_bs64_pil_resize import *
    from .mmpretrain.mmpretrain.configs._base_.default_runtime import *
    from .mmpretrain.mmpretrain.configs._base_.schedules.imagenet_bs4096_adamw import *
...
model = dict(
    ...
    backbone=dict(
        ...
        module=dict(
            ...
            drop_rate=0.1,
            init_cfg=dict(
                type=PretrainedInit, checkpoint='', prefix='backbone')),
        alpha=16,
        rank=16,
        drop_rate=0.1,
